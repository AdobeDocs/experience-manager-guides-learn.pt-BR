...
# Lançamento do Adobe Experience Manager Guides as a Cloud Service em fevereiro
...
3. Confirme as alterações e execute o pipeline do Cloud Services para atualizar para a versão de fevereiro do AEM Guides as a Cloud Service.
...
O AEM Guides as a Cloud Service oferece aprimoramentos e novos recursos na versão de fevereiro:
