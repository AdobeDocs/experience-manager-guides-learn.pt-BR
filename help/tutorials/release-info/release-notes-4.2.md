...
Esta nota de versão aborda as instruções de atualização, a matriz de compatibilidade e os problemas corrigidos na versão 4.2 dos Guias da Adobe Experience Manager (mais tarde chamados de *Guias do AEM*).
