...
A partir do AEM Guides 1.1, também é possível publicar documentos do FrameMaker \(`.book` e `.fm`\) disponível em seu repositório AEM. Se um arquivo de livro contiver uma combinação de documentos DITA e FrameMaker, o AEM Guides permite publicar esses documentos também. Os documentos do FrameMaker podem ser publicados nos seguintes formatos:
