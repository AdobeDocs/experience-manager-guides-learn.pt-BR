---
title: Painéis
description: Utilização de painéis em guias AEM
...
O Editor da Web de Guias do AEM é dividido em várias seções, incluindo uma barra de ferramentas principal, uma barra de ferramentas secundária, um painel esquerdo, uma área de edição de conteúdo e um painel direito.
...
1. Clique em [!UICONTROL **Barra lateral**] ícone para expandir o painel.

   ![Expandir Barra Lateral](images/lesson-5/expand-sidebar.png)

1. Clique em [!UICONTROL **Barra lateral**] para recolher o painel.
...
1. Clique em [!UICONTROL **Plus**] ícone.

   ![Favoritos Plus](images/lesson-5/favorites-plus.png)

1. Na caixa de diálogo Nova coleção, insira uma **Título** e uma **Descrição**.
...
1. Selecionar **Visualização do repositório** no painel esquerdo.

1. Clique em [!UICONTROL **Reticências**] localizado ao lado de um tópico para acessar opções contextuais.

1. Selecionar **Adicionar a** > **Favoritos**.

1. Na caixa de diálogo Adicionar a favoritos, escolha **Nova coleção** ou **Coleção existente**.
...
1. Clique com o botão direito do mouse no arquivo **Guia Título** no Editor para acessar opções contextuais.

1. Escolher **Adicionar a** > **Favoritos**.

   ![Adicionar a Favoritos](images/lesson-5/addto-favorites.png)
...
1. Em Favoritos, clique na guia [!UICONTROL **Seta**] ícone ao lado de uma coleção para exibir seu conteúdo.

   ![Exibir Favoritos](images/lesson-5/view-favorites.png)

1. Clique em [!UICONTROL **Reticências**] ao lado de um tópico para exibir opções contextuais, incluindo a opção para excluí-lo da lista Favoritos.
...
1. Clique em [!UICONTROL **Filtrar pesquisa**] ícone.

   ![Ícone de Filtro do Repositório](images/lesson-5/repository-filter-icon.png)
...
Vários recursos úteis estão disponíveis na Exibição de mapa, incluindo a capacidade de fazer check-out e bloquear arquivos, visualizar o arquivo de mapa, abrir o painel de mapa e exibir o mapa na interface do usuário do Assets.

Consulte a lição intitulada [Mapas e Livros](./maps-and-bookmaps.md) neste curso, para obter mais informações sobre a Exibição de Mapa e sua funcionalidade.
...
Consulte a lição intitulada [Modo de Estrutura de Tópicos](./outline-view.md) neste curso, para obter mais informações sobre a Exibição de estrutura de tópicos e sua funcionalidade.
...
1. Na caixa de diálogo Novo trecho, adicione uma **Título** e uma **Descrição**.
...
1. Abrir um tópico no **Editor XML**.

1. Selecione um **element**.
...
1. Clique em [!UICONTROL  **Propriedades do arquivo**] no painel direito.

   ![Ícone Propriedades do arquivo](images/lesson-5/file-properties-icon.png)

1. Defina o **Estado do documento** para **Editar**. Observe que a lista Referências está atualmente em branco.

   ![Sem referências](images/lesson-5/no-references.png)

1. Feche o tópico.

1. Selecionar [!UICONTROL **Visualização do repositório**] no painel esquerdo.

1. Abra um mapa.

   A exibição é alterada para Exibição de mapa.

1. Clique em [!UICONTROL **Editar**] ícone.

   ![Ícone Editar mapa](images/lesson-5/edit-map-icon.png)

1. Quando o mapa estiver aberto para edição, volte para **Visualização do repositório**.

1. Arraste e solte o tópico com o qual você está trabalhando no mapa.

1. Clique em [!UICONTROL **Salvar**] ícone na barra de ferramentas superior.
...
1. Clique em [!UICONTROL **Revisão**] no painel direito.
